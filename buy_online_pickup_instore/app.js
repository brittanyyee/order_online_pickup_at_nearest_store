...
function initMap() {
  ...
  map.data.addListener('click', (event) => {
    ...
    const content = sanitizeHTML`
      <img style="float:left; width:200px; margin-top:30px" src="https://maps.googleapis.com/maps/api/streetview?size=350x250&location=${position.lat()},${position.lng()}&key=${apiKey}">
